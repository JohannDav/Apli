...
\C1~0\ : maxii_lcell
-- Equation(s):
-- \C1~0_combout\ = (\A1~combout\ & ((\B1~combout\) # ((\A0~combout\ & \B0~combout\)))) # (!\A1~combout\ & (\A0~combout\ & (\B0~combout\ & \B1~combout\)))
...
\C2~0\ : maxii_lcell
-- Equation(s):
-- \C2~0_combout\ = ((\A2~combout\ & (\C1~0_combout\)))
...
\C2~1\ : maxii_lcell
-- Equation(s):
-- \C2~1_combout\ = (\B2~combout\ & ((\A2~combout\) # ((\C1~0_combout\))))
...
\Cs~0\ : maxii_lcell
-- Equation(s):
-- \Cs~0_combout\ = (\A3~combout\ & ((\C2~0_combout\) # ((\B3~combout\) # (\C2~1_combout\)))) # (!\A3~combout\ & (\B3~combout\ & ((\C2~0_combout\) # (\C2~1_combout\))))
...
\S3~0\ : maxii_lcell
-- Equation(s):
-- \S3~0_combout\ = \A3~combout\ $ (\B3~combout\ $ (((\C2~0_combout\) # (\C2~1_combout\))))
...
\S2~0\ : maxii_lcell
-- Equation(s):
-- \S2~0_combout\ = \B2~combout\ $ (\A2~combout\ $ (((\C1~0_combout\))))
